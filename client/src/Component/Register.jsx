                    ...
                    <div className="divide-y divide-gray-200">
                        <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <div className="relative">
                                ...
                                {!isPasswordMatch && <span className="text-red-500 text-sm">Passwords do not match</span>}
                            </div>
                            <div className="relative flex flex-col justify-center gap-0.5">


                                <button 
                                    className="bg-cyan-500 text-white rounded-md px-2 py-1 mt-8 mb-5" 
